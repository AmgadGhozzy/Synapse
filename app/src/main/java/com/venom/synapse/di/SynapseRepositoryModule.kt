...
import com.venom.synapse.data.repo.PremiumRepositoryImpl
...
import com.venom.synapse.domain.repo.IPremiumRepository
...
import com.venom.synapse.domain.repo.ISocialProofRepository
...
abstract class SynapseRepositoryModule {
    ...
    @Binds @Singleton
    abstract fun bindPdfRepository(impl: PdfRepositoryImpl): IPdfRepository
