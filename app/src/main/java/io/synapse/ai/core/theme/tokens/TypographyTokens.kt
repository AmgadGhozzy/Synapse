...
fun buildThemedTypography(
    ...
    val fontFamily = if (isArabic) Cairo else InterBold
    ...
    val platformStyle = PlatformTextStyle(includeFontPadding = !isArabic)
    val lineHeightStyle = if (isArabic) {
        LineHeightStyle(
    ...
    return Typography(
        ...
        titleLarge = TypeScale.TitleLarge.themed(22f, 26f),
